...
const CODE_TEMPLATE_PATH: &str = "/chapter9/complete_project/web_template/src/code_template.rs";

pub const WEB_SERVER_PROJECT_PATH: &str = "/chapter9/complete_project/web_template";

pub const EXEC_MAIN_PATH: &str = "/chapter9/complete_project/web_template/src/main.rs";

const API_SCHEMA_PATH: &str = "/chapter9/complete_project/schemas/api_schema.json";
